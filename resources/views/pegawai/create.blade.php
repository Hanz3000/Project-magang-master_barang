...
<div id="successModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <div class="bg-green-50 px-4 py-3 sm:px-6 flex items-center">
            ...
            <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <p class="text-sm text-gray-700" id="successMessage"></p>
            </div>
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
...
<script>
    ...
    function addNewDivisi() {
        ...
        .then(data => {
            if (data.success) {
                ...
                showSuccessMessage('Divisi berhasil ditambahkan.');
            } else {
    ...
    function updateDivisi() {
        ...
        .then(data => {
            if (data.success) {
                const divisiList = document.getElementById('divisiList');
                const listItems = divisiList.querySelectorAll('li');
                listItems.forEach(item => {
                ...
                showSuccessMessage('Divisi berhasil diperbarui.');
            } else {
    ...
    function deleteDivisi() {
        ...
        .then(data => {
            if (data.success) {
                ...
                showSuccessMessage('Divisi berhasil dihapus.');
            } else {
